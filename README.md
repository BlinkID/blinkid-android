...
* [Android _BlinkID_ integration instructions](#user-content-intro)
* [Quick Start](#user-content-quickStart)
    ...
    * [Performing your first `field by field` scan](#user-content-quickScan)
* [Advanced _BlinkID_ integration instructions](#user-content-advancedIntegration)
    * [Checking if _BlinkID_ is supported](#user-content-supportCheck)
...
* [List of available recognizers](#user-content-recognizerList)
    ...
    * [SIM number recognizer](#user-content-simNumberRecognizer)
    ...
    * [Country-specific BlinkID recognizers](#user-content-blinkid_recognizers_countries)
        * [Australia](#user-content-blinkid_recognizers_australia)
        * [Austria](#user-content-blinkid_recognizers_austria)
        * [Colombia](#user-content-blinkid_recognizers_colombia)
        * [Croatia](#user-content-blinkid_recognizers_croatia)
        * [Cyprus](#user-content-blinkid_recognizers_cyprus)
        * [Czechia](#user-content-blinkid_recognizers_czechia)
        * [Egypt](#user-content-blinkid_recognizers_egypt)
        * [Germany](#user-content-blinkid_recognizers_germany)
        * [HongKong](#user-content-blinkid_recognizers_hongkong)
        * [Indonesia](#user-content-blinkid_recognizers_indonesia)
        * [Ireland](#user-content-blinkid_recognizers_ireland)
        * [Italy](#user-content-blinkid_recognizers_italy)
        * [Jordan](#user-content-blinkid_recognizers_jordan)
        * [Kuwait](#user-content-blinkid_recognizers_kuwait)
        * [Malaysia](#user-content-blinkid_recognizers_malaysia)
        * [Morocco](#user-content-blinkid_recognizers_morocco)
        * [New Zealand](#user-content-blinkid_recognizers_newzealand)
        * [Poland](#user-content-blinkid_recognizers_poland)
        * [Romania](#user-content-blinkid_recognizers_romania)
        * [Serbia](#user-content-blinkid_recognizers_serbia)
        * [Singapore](#user-content-blinkid_recognizers_singapore)
        * [Slovakia](#user-content-blinkid_recognizers_slovakia)
        * [Slovenia](#user-content-blinkid_recognizers_slovenia)
        * [Spain](#user-content-blinkid_recognizers_spain)
        * [Sweden](#user-content-blinkid_recognizers_sweden)
        * [Switzerland](#user-content-blinkid_recognizers_switzerland)
        * [United Arab Emirates](#user-content-blinkid_recognizers_uae)
        * [United Kingdom](#user-content-blinkid_recognizers_uk)
        * [US / Canada](#user-content-blinkid_recognizers_us_canada)
* [`Field by field` scanning feature](#user-content-fieldByFieldFeature)
* [`Processor` and `Parser`](#user-content-processorsAndParsers)
    * [The `Processor` concept](#user-content-processorConcept)
    ...
    * [The `Parser` concept](#user-content-parserConcept)
...
* [Scanning generic documents with Templating API](#user-content-detectorTemplating)
    * [Defining how document should be detected](#user-content-detectorTemplating_detection)
    * [Defining how fields of interest should be extracted](#user-content-detectorTemplating_extraction)
        * [The `ProcessorGroup` component](#user-content-processorGroup)
        * [List of available dewarp policies](#user-content-dewarpPolicyList)
        * [The `TemplatingClass` component](#user-content-templatingClass)
        * [Implementing the `TemplatingClassifier`](#user-content-implementingTemplatingClassifier)
    * [Obtaining recognition results](#user-content-detectorTemplating_results)
* [Extracting additional fields of interest from machine-readable travel documents by using Templating API](#user-content-mrtdTemplating)
* [The `Detector` concept](#user-content-detectorConcept)
...
* [Embedding _BlinkID_ inside another SDK](#user-content-embedAAR)
    * [_BlinkID_ licensing model](#user-content-licensingModel)
        * [Application licenses](#user-content-appLicence)
    * [Ensuring the final app gets all resources required by _BlinkID_](#user-content-sdkIntegrationIntoApp)
* [Processor architecture considerations](#user-content-archConsider)
    ...
    * [Creating customized build of _BlinkID_](#user-content-staticDistrib)
    * [Combining _BlinkID_ with other native libraries](#user-content-combineNativeLibraries)
